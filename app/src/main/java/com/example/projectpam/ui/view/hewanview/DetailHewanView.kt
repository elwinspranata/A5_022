...
fun DetailBody(
    ...
    when (uiState) {
        ...
        is DetailUiState.Success -> Column(
            ...
            ItemDetailHewan(hewan = uiState.hewan)
            Button(
...
fun ItemDetailHewan(
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            ComponentDetailHewan(judul = "Jenis Hewan", isinya = hewan.jenisHewanId)
            Spacer(modifier = Modifier.height(8.dp))

            ComponentDetailHewan(judul = "Pemilik", isinya = hewan.pemilik)
            Spacer(modifier = Modifier.height(8.dp))

            ComponentDetailHewan(judul = "Kontak Pemilik", isinya = hewan.kontakPemilik)
            Spacer(modifier = Modifier.height(8.dp))

            ComponentDetailHewan(judul = "Tanggal Lahir", isinya = hewan.tanggalLahir)
            Spacer(modifier = Modifier.height(8.dp))

            ComponentDetailHewan(judul = "Catatan Kesehatan", isinya = hewan.catatanKesehatan)
            Spacer(modifier = Modifier.height(8.dp))
        }
    }
}
